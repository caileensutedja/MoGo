...
fun RegisterScreen(
    ...
    Column(
        ...
        // Confirmation card — only shown after successful registration.
        // Instructs the user to check their university inbox.
        // Register button is also disabled at this point to prevent re-submission.
        AnimatedVisibility(visible = state is AuthState.AwaitingEmailConfirmation) {
            Card(
                ...
                Text(
                    text = "✅ Check your university inbox! Click the verification " +
        ...
        // Error message — animates in when state is Error, hidden otherwise
        ...
        // Register button — disabled during loading OR after confirmation
